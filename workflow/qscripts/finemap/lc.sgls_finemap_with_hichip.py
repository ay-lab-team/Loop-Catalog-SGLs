...
parser.add_argument('--prefix', type=str, required=True, help='Prefix save the results, including the output directory.')
...
gwas_hichip.columns = ['chrA_loop', 'startA_loop', 'endA_loop',
                       ...
                       '-log10_qval_loop', 'chr_snp', 'start_snp', 'end_snp', 'rsid', 'ppa_snp']
...
finemap_sgls_fn = '{}finemap_sgls.tsv'.format(args.prefix)
